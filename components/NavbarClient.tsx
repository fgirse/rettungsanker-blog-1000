      ...
      {/* Mobile Menu - Main menu items only */}
            {isMobileMenuOpen && (
              <div className="lg:hidden bg-slate-800 px-3 sm:px-4 py-3 sm:py-4 flex flex-col gap-2 sm:gap-3 pb-20">
                <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                    <Link href="/" className="uppercase text-gray-50 hover:bg-orange-400 px-2 lg:px-3 py-1 lg:py-2 rounded font-bowlby text-xl lg:text-sm xl:text-base 2xl:text-lg"> Start</Link>
                </div>
                <div>
                  <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                    <Link href="/about" className="uppercase text-gray-50 hover:bg-orange-400 px-2 lg:px-3 py-1 lg:py-2 rounded font-bowlby text-xl lg:text-sm xl:text-base 2xl:text-lg"> über uns</Link>
                </div>
                  <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                    <Link href="/drinks" className="uppercase text-gray-50 hover:bg-orange-400 px-2 lg:px-3 py-1 lg:py-2 rounded font-bowlby text-xl lg:text-sm xl:text-base 2xl:text-lg"> angebot</Link>
                </div>
               <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                    <Link href="/sportarena" className="uppercase text-gray-50 hover:bg-orange-400 px-2 lg:px-3 py-1 lg:py-2 rounded font-bowlby text-xl lg:text-sm xl:text-base 2xl:text-lg"> sportarena</Link>
                </div>
                   <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                    <Link href="/wohin" className="uppercase text-gray-50 hover:bg-orange-400 px-2 lg:px-3 py-1 lg:py-2 rounded font-bowlby text-xl lg:text-sm xl:text-base 2xl:text-lg"> wohin?</Link>
                </div>
                  <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                   <div className="flex items-center gap-1 lg:gap-2">
                    <Image src={Bulleye} className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7" alt="Bulleye" width={40} height={40} />
                    <Link href="/client" className="uppercase text-gray-50 hover:bg-orange-400 px-2 lg:px-3 py-1 lg:py-2 rounded font-bowlby text-xl lg:text-sm xl:text-base 2xl:text-lg"> Blog</Link>
                </div>
                      <span className="absolute top-5 sm:top-1 -right-8 sm:-right-4 inline-flex items-center justify-center px-1 sm:px-2 py-0.5 text-xs font-bold leading-none text-white bg-red-500 rounded-full">
                        neu
                      </span>
                    </div>
                  </div>
