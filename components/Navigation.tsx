  ...
  return (
    <>
      ...
      <div
        className="relative"
        style={{
             backgroundImage: "url(/Assets/Svg/Wood3.svg)",
             backgroundSize: "cover",
             backgroundPosition: "center",
        }}
      >
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-red-500/90 to-red-500/0" />
      </div>
...
const LINKS = [
  ...
  },
  {
    text: "angebot",
    href: "/drinks",
    component: AngebotContent,
  },
  {
    text: "sportarena",
    href: "/sportarena",
    component: SportarenaContent,
  },
  {
    text: "wohin?",
    href: "/wohin",
