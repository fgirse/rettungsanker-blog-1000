  ...
  return (
    <div className='bg-slate-800 flex flex-col justify-center items-center'>
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto '>
        <h1 className='text-yellow-600 text-3xl font-bold lg:text-6xl'>Willkommen zum Rettungsanker-Blog</h1>
        <p className='text-sm sm:text-base text-gray-100 lg:text-[1.33rem]'>
        ...
        <Link
          href='/search'
          className='text-xl sm:text-sm text-teal-500 font-bold lg:text-2xl hover:underline'
        >
          View all posts
        </Link>
      </div>
      ...
      <div className='p-3 flex flex-col gap-4 lg:gap-24 py-7'>
        <RecentPosts limit={9} />
        <Link
